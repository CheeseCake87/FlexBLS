...
export default function Account() {
    ...
    function updateSystemUser() {
        ...
        ctxMain.api.post(`/update/user/${ctxMain.sessionUserId()}`, {
    ...
    function changePassword() {
        ...
        ctxMain.api.post(`/update/user/${ctxMain.sessionUserId()}/password`, {
    ...
    onMount(() => {
        ...
        ctxMain.api.get(`/system/user/${ctxMain.sessionUserId()}`).then((res) => {
            if (res.ok) {
                setSystemUser({
